...
import (
	...
	erc20Handler "github.com/ChainSafe/chainbridge-core/subchains/celo/bindings/ERC20Handler"
	"github.com/ChainSafe/chainbridge-core/subchains/celo/txtrie"
...
func HandleErc20DepositedEventCelo(sourceID, destId uint8, nonce uint64, handlerContractAddress string, backend listener.ChainReader, block, txIndex *big.Int, args ...interface{}) (relayer.XCMessager, error) {
